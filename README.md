...
> **_NOTE:_**  This project is now integrated and maintained withing the [LIBFT](https://github.com/1mthe0wl/libft) library, and no more update will come to here, however the documentation will be still relevant.
